      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div>
          ...
          <select {...f('property_type')} className="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm">
            {['Nursing Home','Care Home','Holiday Park','Factory Unit','Domestic','Commercial','Community Centre','Doctors Surgery','Dental Surgery','Garden Centre','Other'].map(t => <option key={t}>{t}</option>)}
          </select>
        </div>
        <div>
